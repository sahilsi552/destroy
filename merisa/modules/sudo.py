...
# @QuantamBot.on_message(filters.command(["gban", "cgban"]) & filters.user(OWNER_ID))
# async def useradd(b, message):
#     m = message.reply_to_message.from_user.id
#     try:
#         if m not in BANNED:
#             BANNED.add(m)
#             await message.reply_text("Added to banned list")
#         else:
...
# @QuantamBot.on_message(filters.command(["ungban", "cungban"]) & filters.user(OWNER_ID))
# async def useradd(b, message):
#     m = message.reply_to_message.from_user.id
#     try:
#         if m in BANNED:
#             BANNED.discard(m)
#             await message.reply_text("Removed from banned list")
#         else:
#             return await message.reply_text("this user is not yet banned")
#     except Exception as e:
#         await message.reply_text(f"ᴇʀʀᴏʀ : {e}")


# @QuantamBot.on_message(filters.command(["cgbannedlist"]) & filters.user(OWNER_ID))
# async def gbanlist(b, message):
#     try:
